...
const id: Messages = {
  ...
  portal: {
    ...
    pendingStepsTitle: "Apa yang terjadi selanjutnya",
    pendingStepReview: "Penjual meninjau file dan spesifikasi Anda",
    pendingStepApprove: "Setelah disetujui, produksi langsung dimulai",
    pendingStepConfirm: "Kami kabari Anda saat pesanan mulai bergerak",
