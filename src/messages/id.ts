...
const id: Messages = {
  auth: {
    ...
    forgotPasswordDesc: "Masukkan alamat email Anda dan kami akan mengirimkan tautan atur ulang kata sandi.",
    sendResetLink: "Kirim tautan atur ulang",
    resetLinkSent: "Jika akun terdaftar dengan email ini, instruksi atur ulang kata sandi telah dikirimkan.",
    resetPasswordTitle: "Atur ulang kata sandi",
    resetPasswordDesc: "Masukkan kata sandi baru untuk akun Anda.",
    resetPassword: "Atur ulang kata sandi",
    resetPasswordSuccess: "Kata sandi Anda telah berhasil diatur ulang. Anda sekarang dapat masuk.",
    invalidResetToken: "Tautan atur ulang tidak valid atau sudah kadaluwarsa. Silakan minta tautan baru.",
  ...
  breadcrumb: {
    ...
    productTemplates: "Template Produk",
    ...
    noOrganization: "Belum tergabung organisasi",
  ...
  org: {
    ...
    businessModelDescription: 'Pilih produk awal yang sesuai dengan bisnis Anda.',
    businessModelLoading: 'Memuat model bisnis...',
    businessModelUnavailable: 'Model bisnis sedang tidak tersedia.',
    businessModelRequired: 'Pilih model bisnis untuk melanjutkan.',
    templateMaterializationFailed: 'Produk awal tidak dapat disiapkan.',
  },
  sidebar: {
    dashboard: "Dasbor",
    orders: "Pesanan",
  ...
  products: {
    title: "Produk",
    listDescription: "Kelola produk yang dijual organisasi Anda.",
    createTitle: "Buat Produk",
    template: 'Template Produk',
    templatePlaceholder: 'Pilih template produk',
    templateSource: 'Template sumber',
    templateSourceDescription: 'Pengaturan produk disalin dari template ini saat dibuat.',
    templateNoSource: 'Produk lama tanpa template sumber',
  ...
  productTemplates: {
    ...
    listDescription:
      "Konfigurasi produksi yang dapat digunakan ulang untuk produk Anda.",
    ...
    delete: "Hapus",
    deleteConfirm:
      "Anda yakin ingin menghapus template ini secara permanen?",
    name: "Nama Template",
    namePlaceholder: "Cth. Kaos Kustom",
    description: "Deskripsi",
    descriptionPlaceholder: "Jelaskan template",
    category: "Kategori",
    categoryPlaceholder: "Cth. Pakaian",
    status: "Status",
    ...
    noTemplatesDesc:
      "Buat template produk pertama Anda untuk digunakan ulang di produk.",
    noResults: "Tidak ada template yang cocok",
    loadFailed: "Gagal memuat template",
    loadFailedDesc: "Periksa koneksi Anda dan coba lagi.",
    created: "Template berhasil dibuat",
    updated: "Template berhasil diperbarui",
    duplicated: "Template berhasil diduplikasi",
    archived: "Template diarsipkan",
    deleted: "Template dihapus",
    mutationFailed: "Template tidak dapat disimpan. Silakan coba lagi.",
    archiveConfirm: "Anda yakin ingin mengarsipkan template ini?",
    itemizationMode: "Mode Itemisasi",
    itemizationUniform: "Seragam",
    itemizationMatrix: "Matriks",
    itemizationPerItem: "Per Item",
    basePrice: "Harga Dasar",
    productionDays: "Hari Produksi",
    minQuantity: "Min. Kuantitas",
    productionNotes: "Catatan Produksi",
    configurationSummary: "Atur detail template yang dapat digunakan ulang.",
    fields: {
      title: "Kolom Kustom",
      add: "Tambah Kolom",
      empty: "Belum ada kolom yang dikonfigurasi",
      key: "Kunci Kolom",
      label: "Label Kolom",
      type: "Tipe Kolom",
      required: "Wajib",
      ...
      noOptions: "Belum ada opsi yang dikonfigurasi",
      typeText: "Teks",
      typeTextPerItem: "Teks per Item",
      typeNumberPerItem: "Angka per Item",
      typeSelect: "Pilihan",
      typeFile: "Berkas",
      typeMatrix: "Matriks",
    },
    stages: {
      title: "Tahapan Alur Kerja",
      add: "Tambah Tahapan",
      empty: "Belum ada tahapan alur kerja yang dikonfigurasi",
      key: "Kunci Tahapan",
      label: "Label Tahapan",
      board: "Papan",
      position: "Posisi",
      remove: "Hapus tahapan",
    ...
    bom: {
      title: "Item BOM",
      add: "Tambah Item",
      empty: "Belum ada item BOM yang dikonfigurasi",
      materialId: "ID Material",
      basis: "Dasar",
      quantity: "Kuantitas",
      unit: "Satuan",
      wastePercent: "Persentase Limbah",
      critical: "Kritis",
      remove: "Hapus item",
      fieldKey: "Kunci Kolom",
      basisPerOrder: "Per Pesanan",
      basisPerItem: "Per Item",
      basisMatrix: "Matriks",
      basisPerItemField: "Per Kolom Item",
    },
    materialization: {
      title: "Materialisasi",
      description:
        "Salin template produk awal dari model bisnis ke organisasi Anda.",
      source: "Sumber",
      copiedTo: "Template berhasil disalin ke organisasi Anda",
      fromBusinessTemplate: "Dari model bisnis",
      noBusinessTemplate: "Belum ada model bisnis yang dipilih",
      failed: "Template produk awal tidak dapat disiapkan.",
    },
    provenance: {
      title: "Asal Usul",
      description:
        "Telusuri dari mana template ini berasal dan dari apa template ini diturunkan.",
      sourceTemplate: "Template Sumber",
      sourceTemplateLabel: "Sumber",
      derivedFrom: "Diturunkan dari template model bisnis",
      noSource: "Dibuat manual di organisasi ini",
    },
    protectedDelete: {
      title: "Template tidak dapat dihapus",
      description:
        "Template ini dirujuk oleh produk. Arsipkan template atau hapus referensinya sebelum menghapus.",
      referencedByProducts:
        "Template ini tidak dapat dihapus karena masih dirujuk oleh produk.",
    },
    validation: {
      nameRequired: "Nama template wajib diisi",
      nameMin: "Nama template minimal 2 karakter",
      basePriceRequired: "Harga dasar wajib diisi",
      basePriceNonNegative: "Harga dasar harus nol atau lebih",
      productionDaysRequired: "Hari produksi wajib diisi",
      productionDaysPositive: "Hari produksi minimal 1",
      minQuantityRequired: "Kuantitas minimum wajib diisi",
      minQuantityPositive: "Kuantitas minimum minimal 1",
      invalidConfiguration:
        "Konfigurasi template tidak valid. Periksa kembali detailnya dan coba lagi.",
    },
  },
  invoices: {
    title: "Invoice",
