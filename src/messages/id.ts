...
const id: Messages = {
  ...
  products: {
    ...
    priorityDescription: "Tugas yang dibuat dari produk ini akan ditandai sebagai prioritas.",
    active: "Aktif",
    inactive: "Tidak Aktif",
  ...
  invoices: {
    ...
    invoicePaid: "Invoice ditandai sudah dibayar",
  ...
  production: {
    ...
    createInvoiceAndShip: "Buat Faktur & Kirim",
    courier: "Kurir",
  },
  portal: {
