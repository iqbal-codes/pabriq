...
export type Messages = {
  ...
  orders: {
    ...
    setupMissionLocked: string;
    setupMissionTitle: string;
    setupMissionDescription: string;
    setupMissionProgress: string;
    setupMissionListLabel: string;
    setupMissionComplete: string;
    setupMissionIncomplete: string;
    setupBusinessAddressTitle: string;
    setupBusinessAddressDesc: string;
    setupBusinessAddressAction: string;
    setupProductionStagesTitle: string;
    setupProductionStagesDesc: string;
    setupProductionStagesAction: string;
    setupFirstProductTitle: string;
    setupFirstProductDesc: string;
    setupFirstProductAction: string;
    setupPaymentMethodTitle: string;
    setupPaymentMethodDesc: string;
    setupPaymentMethodAction: string;
    setupMissionHelpTitle: string;
    setupMissionHelpBody: string;
  ...
  org: {
    ...
    businessModelLoading: string;
    businessModelUnavailable: string;
    businessModelRequired: string;
    templateMaterializationFailed: string;
  };
  sidebar: {
    dashboard: string;
    orders: string;
  ...
  products: {
    ...
    templateSourceDescription: string;
    templateNoSource: string;
    productInfo: string;
  ...
  productTemplates: {
    ...
    itemizationUniform: string;
    itemizationMatrix: string;
    itemizationPerItem: string;
    basePrice: string;
    productionDays: string;
    minQuantity: string;
    productionNotes: string;
    ...
    fields: {
      ...
      noOptions: string;
      typeText: string;
      typeTextPerItem: string;
      typeNumberPerItem: string;
      typeSelect: string;
      typeFile: string;
      typeMatrix: string;
    };
    ...
    bom: {
      ...
      remove: string;
      fieldKey: string;
      basisPerOrder: string;
      basisPerItem: string;
      basisMatrix: string;
      basisPerItemField: string;
    };
    materialization: {
      title: string;
      description: string;
      source: string;
      copiedTo: string;
      fromBusinessTemplate: string;
      noBusinessTemplate: string;
      failed: string;
    };
    provenance: {
      title: string;
    ...
    protectedDelete: {
      title: string;
      description: string;
      referencedByProducts: string;
    };
    validation: {
      nameRequired: string;
      nameMin: string;
      basePriceRequired: string;
      basePriceNonNegative: string;
      productionDaysRequired: string;
      productionDaysPositive: string;
      minQuantityRequired: string;
      minQuantityPositive: string;
