...
>>>>>>> 502307f (refactor: rename order item name to designName, resolve product name from products table)
    ...
    timelineProductionComplete: "Production is complete",
    ...
    pendingStepReview: "Seller reviews your files and specs",
    pendingStepApprove: "Once approved, production begins immediately",
    pendingStepConfirm: "We'll let you know the moment it moves forward",
