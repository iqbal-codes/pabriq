...
const en: Messages = {
  auth: {
    ...
    resetLinkSentDesc: "If an account exists for that email, we sent a password reset link.",
    backToSignIn: "Back to sign in",
    resetPassword: "Reset password",
    resetPasswordTitle: "Choose a new password",
    resetPasswordDesc: "Enter a new password for your Pabriq account.",
    newPassword: "New password",
    confirmPassword: "Confirm password",
    passwordMismatch: "Passwords do not match",
    passwordResetSuccess: "Password reset complete",
    passwordResetSuccessDesc: "Your password has been updated. You can now sign in.",
    invalidResetLink: "This password reset link is invalid or has expired.",
    verificationPendingTitle: "Check your inbox",
    verificationPendingDesc: "We sent a verification link. Open it to verify your email address.",
    verificationSent: "Verification email sent",
    verificationSentDesc: "If this email belongs to an account, a verification link is on its way.",
    resendVerification: "Resend verification email",
    emailVerifiedTitle: "Email verified",
    emailVerifiedDesc: "Your email address is verified. Continue to Pabriq.",
    invalidVerificationLink: "This verification link is invalid.",
    verificationExpired: "This verification link has expired.",
    emailNotVerified: "Verify your email address before signing in.",
    checkInbox: "Check your inbox",
    continueToApp: "Continue to Pabriq",
  },
  admin: {
    logOut: "Log out",
    ...
    unpaidInvoicesTotal: "Unpaid Invoices (Total)",
    productionBottlenecks: "Production Bottlenecks",
    ...
    suspendOrgDesc: "Are you sure you want to suspend {name}? This will disable write operations.",
    restoreOrg: "Restore Organization",
    restoreOrgDesc: "Are you sure you want to restore {name}? This will re-enable write operations.",
    exportOrg: "Export Organization Data",
    exportOrgDesc: "Initiate a data export for {name}?",
    ...
    monthlyPriceCents: "Monthly Price (cents)",
    annualPriceCents: "Annual Price (cents)",
    status: "Status",
    created: "Created",
    active: "Active",
    inactive: "Inactive",
    ...
    grantAdminDesc: "Grant platform admin access to a user by email.",
    userName: "Name",
    email: "Email",
    ...
    revokeAdminDesc: "Are you sure you want to revoke platform admin access?",
    grant: "Grant",
    ...
    exportDataDesc: "Download all organization data as JSON file",
    executeExport: "Export Now",
    exportCompleted: "Export completed. You can download it from the Exports page.",
    retentionPolicies: "Retention Policies",
    createPolicy: "Create Policy",
    createPolicyDesc: "Set data retention policy for tables",
    targetTable: "Target Table",
    retentionDays: "Retention (days)",
    enabled: "Enabled",
    disabled: "Disabled",
    deletePolicy: "Delete Policy",
    deletePolicyDesc: "Are you sure you want to delete this retention policy?",
    ...
    atLimit: "At limit",
    upgradePrompt: "Upgrade your plan to increase limits",
  ...
  org: {
    ...
    provisioningFailed: "Failed to initialize organization setup",
  ...
  invoices: {
    ...
    rejectPaymentDesc: "Rejecting a payment will mark it as rejected. Please provide a clear reason for audit purposes.",
    rejectionReason: "Rejection Reason",
    rejectionReasonRequired: "A reason is required when rejecting a payment",
    ...
    reconcileNoOrderId: "No Midtrans transaction linked to this invoice",
     ...
     reconcileGatewayUnavailable: "Midtrans is temporarily unavailable. Please try again later.",
     reconcileManualReview: "This payment needs manual review by an operator.",
  ...
  production: {
    ...
    wastePercentage: "(+{percentage}% waste)",
    attachments: "Attachments",
    ...
    trackingNumberRequired: "Tracking number is required when using a courier",
    ...
    tabThreeColumn: "Three-column view",
  ...
  portal: {
    ...
    timelineProductionComplete: "Completed",
    ...
    midtransSdkNotLoaded: "Midtrans SDK not loaded yet. Please try again.",
    ...
    paymentVerifying: "Verifying your payment...",
     ...
     paymentAmountMismatch: "The payment amount could not be verified. Please contact support.",
     paymentGatewayUnavailable: "The payment gateway is temporarily unavailable. Please try again later.",
     paymentManualReview: "Your payment needs manual review. We will update you shortly.",
    shipmentTracking: "Shipment Tracking",
    storePickup: "Store Pickup",
    trackShipment: "Track shipment",
    orderTimelineSectionTitle: "Order History",
    timelineLastUpdatePrefix: "Last Update: ",
    timelineExpand: "View details",
    timelineCollapse: "Hide",
    orderTimelineEmpty: "No updates yet",
    timelineDraftCreated: "Draft order created",
    timelineDraftConfirmed: "Draft order confirmed, awaiting review",
    timelineOrderApproved: "Order approved by admin",
    timelineDpInvoiceCreated: "DP invoice created",
    timelinePaymentDpConfirmed: "DP payment confirmed",
    timelineProductionStarted: "Production started",
    timelineFinalInvoiceCreated: "Final invoice created",
    timelinePaymentFinalConfirmed: "Final payment confirmed",
    ...
    timelineDateUnavailable: "Date not recorded",
    timelineShowAll: "Show full progress",
    timelineShowLess: "Hide future steps",
  },
  combobox: {
